.PHONY: journal enhance test test-integration clean test-enhance
...
test-enhance: $(VENV)/bin/activate
	...
	$(PYTHON) scripts/enhance_entries.py $(TEST_FILE) --output $(TEST_ENHANCED)
	@echo "\nEnhanced content:"
	@cat $(TEST_ENHANCED)
...
clean:
	rm -f $(JOURNAL_FILE) $(ENHANCED_FILE) $(TEST_FILE) $(TEST_ENHANCED)
...
help:
	...
	@echo "  make enhance                     - Enhance journal with AI context"
	...
	@echo "  3. make enhance                  # Add AI context"
